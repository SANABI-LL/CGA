...
const CAMPUS_LOCATIONS = new Map<string, { lat: number; lng: number; displayName: string }>([
  ...
  // Non-building landmarks — these were missing, causing anchor hallucination when
  // the model fell back to guessing a building name from memory.
  ...
  ['main quadrangle', { lat: 41.7886, lng: -87.5987, displayName: 'Main Quadrangle' }],
  ['the quad', { lat: 41.7886, lng: -87.5987, displayName: 'Main Quadrangle' }],
  ['harper quad', { lat: 41.7880, lng: -87.5995, displayName: 'Harper Quadrangle' }],
  ['harper quadrangle', { lat: 41.7880, lng: -87.5995, displayName: 'Harper Quadrangle' }],
  ['bartlett quad', { lat: 41.7920, lng: -87.5983, displayName: 'Bartlett Quadrangle' }],
  ['bartlett quadrangle', { lat: 41.7920, lng: -87.5983, displayName: 'Bartlett Quadrangle' }],
  ['hutchinson court', { lat: 41.7902, lng: -87.5985, displayName: 'Hutchinson Court' }],
  ['hutch court', { lat: 41.7902, lng: -87.5985, displayName: 'Hutchinson Court' }],
  ...
  ['midway plaisance', { lat: 41.7828, lng: -87.5998, displayName: 'Midway Plaisance' }],
  ['the midway', { lat: 41.7828, lng: -87.5998, displayName: 'Midway Plaisance' }],
  ...
  ['rockefeller chapel', { lat: 41.7886, lng: -87.5987, displayName: 'Rockefeller Memorial Chapel' }],
  ['rockefeller memorial chapel', { lat: 41.7886, lng: -87.5987, displayName: 'Rockefeller Memorial Chapel' }],
