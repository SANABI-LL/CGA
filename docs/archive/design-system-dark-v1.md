# CampusGeo Design System (ARCHIVED)
## University of Chicago AI Geospatial Agent

> **归档说明（2026-07-05）**：本文件是早期的深色模式设计系统（EB Garamond + Plus Jakarta Sans，近黑背景），已被 `CLAUDE.md` 中的 Editorial Cartography 方向（Fraunces + IBM Plex，暖纸色）取代。仅作历史参考，不再作为设计依据。
